...
CREATE TABLE IF NOT EXISTS `#__j2store_ordercoupons` (
  `j2store_ordercoupon_id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`j2store_ordercoupon_id`),
  KEY `coupon_order_id` (`order_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `#__j2store_voucherhistories` (
  `j2store_voucherhistory_id` int(11) NOT NULL AUTO_INCREMENT,
  `voucher_id` int(11) NOT NULL,
  `order_id` varchar(255) NOT NULL,
  `voucher_code` varchar(255) NOT NULL,
  `voucher_to_email` varchar(255) NOT NULL,
  `amount` decimal(12,4) NOT NULL,
  `created_on` datetime NOT NULL,
  PRIMARY KEY (`j2store_voucherhistory_id`),
  KEY `voucherhistory_order_id` (`order_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8;
