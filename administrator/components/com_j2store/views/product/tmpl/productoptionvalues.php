				...
				<thead>
					...
					<?php if($this->product->product_type =='simple'):?>
						...
						<?php endif;?>
							...
							<!-- <td>
								<?php // echo J2Html::text( $this->prefix.'['.$poptionvalue->j2store_product_optionvalue_id.'][product_optionvalue_sku]' , $poptionvalue->product_optionvalue_sku,array('id'=>'product_optionvalue_sku' ,'class'=>'input-small'));?>
							</td>-->
							...
							<td>
								...
								<!--
								<a  class="btn btn-danger" href="index.php?option=com_j2store&view=products&task=deleteProductOptionvalues&product_id=<?php echo $this->product_id;?>&productoption_id=<?php echo $poptionvalue->productoption_id; ?>&cid[]=<?php echo $poptionvalue->j2store_product_optionvalue_id;?>">
								 -->
